defmodule TimesheetWeb.JobControllerTest do
  ...
  @create_attrs %{job_code: "some job_code"}
  @update_attrs %{job_code: "some updated job_code"}
  @invalid_attrs %{job_code: nil}
  ...
  describe "update job" do
    ...
    test "redirects when data is valid", %{conn: conn, job: job} do
      ...
      assert html_response(conn, 200) =~ "some updated job_code"
    end
