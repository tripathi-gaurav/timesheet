defmodule Timesheet.RolesTest do
  ...
  describe "roles" do
    ...
    @valid_attrs %{desc: "some desc", role_id: 42}
    @update_attrs %{desc: "some updated desc", role_id: 43}
    @invalid_attrs %{desc: nil, role_id: nil}
