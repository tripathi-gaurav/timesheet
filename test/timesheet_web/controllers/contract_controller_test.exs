defmodule TimesheetWeb.ContractControllerTest do
  ...
  describe "new contract" do
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.contract_path(conn, :new))
  ...
  describe "create contract" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert redirected_to(conn) == Routes.contract_path(conn, :show, id)
  ...
  describe "edit contract" do
    ...
    test "renders form for editing chosen contract", %{conn: conn, contract: contract} do
      conn = get(conn, Routes.contract_path(conn, :edit, contract))
  ...
  describe "update contract" do
    ...
    test "redirects when data is valid", %{conn: conn, contract: contract} do
      ...
      assert redirected_to(conn) == Routes.contract_path(conn, :show, contract)

      conn = get(conn, Routes.contract_path(conn, :show, contract))
  ...
  describe "delete contract" do
    ...
    test "deletes chosen contract", %{conn: conn, contract: contract} do
      ...
      assert redirected_to(conn) == Routes.contract_path(conn, :index)
